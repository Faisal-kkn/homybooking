...
showThemeDate(pr_class,pr_data_utc)+'</div>'+'<input type="date" class="t-input-'+pr_class+'"'+' value="'+pr_fm_input+'" name="'+pr_input+'" id="t-input-'+pr_class+'" hidden onkeyup="saveValue(this)">'}
